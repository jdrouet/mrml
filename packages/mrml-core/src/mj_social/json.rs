...
mod tests {
    ...
    fn serialize() {
        ...
        assert_eq!(
            ...
            r#"{"type":"mj-social","attributes":{"margin":"42px"},"children":[]}"#
        );
    }

    #[test]
    fn deserialize() {
        let json = r#"{"type":"mj-social","attributes":{"margin":"0px"},"children":[{"type":"mj-social-element","attributes":{"name":"twitter"},"children":[]},{"type":"comment","children":"World"}]}"#;
