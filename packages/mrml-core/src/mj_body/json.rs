...
#[derive(Default)]
struct MJBodyVisitor;

impl<'de> Visitor<'de> for MJBodyVisitor {
    type Value = MJBody;
...
impl<'de> Deserialize<'de> for MJBody {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
        deserializer.deserialize_map(MJBodyVisitor::default())
    }
}
