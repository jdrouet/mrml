...
mod tests {
    ...
    fn serialize() {
        ...
        assert_eq!(
            ...
            r#"{"type":"mj-navbar","attributes":{"margin":"42px"},"children":[]}"#
        );
    }

    #[test]
    fn deserialize() {
        let json = r#"{"type":"mj-navbar","attributes":{"margin-bottom":"20px"},"children":[{"type":"mj-navbar-link","attributes":{},"children":[]},{"type":"comment","children":"World"}]}"#;
